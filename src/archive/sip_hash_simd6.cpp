...
#define SIPROUND_NEON(v0, v1, v2, v3, v10, v11, v12, v13, v20, v21, v22, v23)          \
    v0 = vaddq_u64(v0, v1);                    \
    v2 = vaddq_u64(v2, v3);                    \
...
void sip_hash_6x(const uint64_t * v, uint32_t * nonces, uint32_t * results) {
    ...
    uint64x2_t final3 = veorq_u64(veorq_u64(v20, v21), veorq_u64(v22, v23));
    ...
    uint32_t *final_ptr3 = (uint32_t *)&final3;
    results[4] = final_ptr3[0];
    results[5] = final_ptr3[1];
}